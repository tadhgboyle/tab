            ...
            <div class="box">
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left">
                        ...
                        <input type="number" step="0.01" name="balance" class="input" value="{{ $user->balance ?? number_format(old('balance'), 2, ".", "") }}">
                    </div>
                </div>
                ...
                @foreach($categories as $category)
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            ...
                            <input type="number" step="0.01" name="limit[{{ $category['id'] }}]" class="input" placeholder="Limit" value="{{ isset($user) ? $category['info']->limit_per : -1.00}}" required>
                        </div>
                        <div class="control">
                            <label class="radio">
